...
for namad in list:
    ...
    net_profit = ["error" , "error"]
    sal = ["error" , "error"]
    income = ["error" , "error"]
    profit = ["error" , "error"]
    eps = ["error" , "error"]
    ids = [3220 , 1464 , 1384 , 1285 , 2149 , 1340 , 2997 , 1145 , 1084 , 1145 , 2503 , 1878 , 1890 , 3227 , 1152 , 1165]
        ...
        if driver.find_element(By.XPATH , '//*[@id="ctl00_lblPeriod"]').text == '9 ماهه':
            for id in ids:
                try:
                    ...
                    net_profit[0] = driver.find_element(By.XPATH , f'//*[@id="{id}"]/tbody/tr[20]/td[2]/span').text
                    net_profit[1] = driver.find_element(By.XPATH , f'//*[@id="{id}"]/tbody/tr[20]/td[3]/span').text
                    income[0] = driver.find_element(By.XPATH , f'//*[@id="{id}"]/tbody/tr[2]/td[2]/span').text
                    income[1] = driver.find_element(By.XPATH , f'//*[@id="{id}"]/tbody/tr[2]/td[3]/span').text
                    profit[0] = driver.find_element(By.XPATH , f'//*[@id="{id}"]/tbody/tr[4]/td[2]/span').text
                    profit[1] = driver.find_element(By.XPATH , f'//*[@id="{id}"]/tbody/tr[4]/td[3]/span').text
    ...
    "namad" : namad,
    "1سال مالی" : sal[0],
    "سود خالص" : net_profit[0],
    "درآمد" : income[0],
    "سود ناخالص" : profit[0],
    "eps1" : eps[0],
    "2سال مالی" : sal[1],
    "2سود خالص" : net_profit[1],
    "2درآمد" : income[1],
    "2سود ناخالص" : profit[1],
    "eps2" : eps[1]
    }
